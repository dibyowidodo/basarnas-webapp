...
<link href="css/bootstrap.min.css" rel="stylesheet">
    ...
    <style>
      ...
      .bg-chart {
        background-image: url('assets/brantas_bg.png');
...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6" href="index.html">Disaster Management</a>
...
<div class="container-fluid">
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="row row-cols-1 row-cols-md-2 gx-4 text-center bg-chart">
